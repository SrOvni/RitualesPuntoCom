...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] List<AudioData> startingAudio = new();
    private void Awake()
    {
    ...
    void ApplyVerticalRotationToCamera()
    {
        ...
        {
            Debug.LogWarning("Player controller has no camera");
        }
    }
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawCube(transform.position, new Vector3(characterController.radius, characterController.height, characterController.radius));
    }
}